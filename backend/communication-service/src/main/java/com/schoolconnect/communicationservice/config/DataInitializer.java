...
public class DataInitializer implements CommandLineRunner {
        ...
        public void run(String... args) {
                if (noticeRepository.count() == 0) {
                        ...
                        createNotification(12L, "Upcoming Event",
                                        "Annual Sports Day is scheduled for February 28, 2025.",
                        ...
                        createNotification(7L, "Parent-Teacher Meeting",
                                        ...
                                        Notification.NotificationType.EVENT);
                        createNotification(8L, "Student Marks Update",
                                        "Your child's mid-term exam results are now available.",
                                        Notification.NotificationType.MARKS);
